...
now=$(date);sudo docker-compose exec cli-west-1 kafka-consumer-perf-test --topic test-szenario-01 --messages 1000000 --group=perf-test-3-$now --show-detailed-stats --broker-list broker-west-1:9091 --reporting-interval 500

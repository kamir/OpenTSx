...
public class StateStoreExample5 {

  private static final Logger LOG = LoggerFactory.getLogger(StateStoreExample5.class);
  ...
  public static void main(String[] args) throws Exception {
    ...
    Initializer<Vector<String>> initializer = new Initializer<Vector<String>>() {
      @Override
      public Vector<String> apply() {
        return new Vector<String>();
      }
    };

    Aggregator<? super String, ? super String, Vector<String>> aggregator = new Aggregator<String, String, Vector<String>>() {
      @Override
      public Vector<String> apply(String key, String value, Vector<String> agg) {
        agg.add( value );
        return agg;
      }
    };
    ...
    Merger<? super String, Vector<String>> merger = new Merger<String, Vector<String>>() {
      @Override
      public Vector<String> apply(String key, Vector<String> a, Vector<String> b) {
        a.addAll(b);
        return a;
      }
    };

    KTable<Windowed<String>, Vector<String>> measuredDataPointGroups = builder.stream("refds_events_topic", Consumed.with(stringSerde1, stringSerde2).withOffsetResetPolicy(EARLIEST))
...
//            .map( StateStoreExample4::processArray )
//            .to("TSO-inspection");
  ...
  private static <String> KeyValue<String,Vector> processArray(Windowed<String> stringWindowed, Vector<String> strings) {
      int i = 0;
      for(String s : strings) {
        i++;
      }
      return new KeyValue( stringWindowed , "l=" + i );
  }
  ...
  public static Properties getProperties() {
    ...
    props.put(StreamsConfig.APPLICATION_ID_CONFIG, "StateStoreExample_04");

...
public class EventTSRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6293244118718982443L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EventTSRecord\",\"namespace\":\"com.cloudera.org.opentsx.tsa.data\",\"fields\":[{\"name\":\"eventArray\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"Event\",\"fields\":[{\"name\":\"timestamp\",\"type\":\"long\"},{\"name\":\"uri\",\"type\":\"string\"},{\"name\":\"value\",\"type\":\"double\"}]}}},{\"name\":\"label\",\"type\":\"string\"},{\"name\":\"tStart\",\"type\":\"long\"},{\"name\":\"tEnd\",\"type\":\"long\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<EventTSRecord> ENCODER =
      new BinaryMessageEncoder<EventTSRecord>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<EventTSRecord> DECODER =
      new BinaryMessageDecoder<EventTSRecord>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageDecoder instance used by this class.
   */
  public static BinaryMessageDecoder<EventTSRecord> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<EventTSRecord> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<EventTSRecord>(MODEL$, SCHEMA$, resolver);
  }

  /** Serializes this EventTSRecord to a ByteBuffer. */
  public java.nio.ByteBuffer toByteBuffer() throws java.io.IOException {
    return ENCODER.encode(this);
  }

  /** Deserializes a EventTSRecord from a ByteBuffer. */
  public static EventTSRecord fromByteBuffer(
      java.nio.ByteBuffer b) throws java.io.IOException {
    return DECODER.decode(b);
  }

   private java.util.List<Event> eventArray;
   ...
   */
  public EventTSRecord(java.util.List<Event> eventArray, java.lang.CharSequence label, java.lang.Long tStart, java.lang.Long tEnd) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: eventArray = (java.util.List<Event>)value$; break;
   ...
   */
  public java.util.List<Event> getEventArray() {
    return eventArray;
  }
   ...
   */
  public void setEventArray(java.util.List<Event> value) {
   ...
   * @return A new EventTSRecord RecordBuilder
   */
  public static EventTSRecord.Builder newBuilder() {
    return new EventTSRecord.Builder();
  }
   ...
   * @return A new EventTSRecord RecordBuilder
   */
  public static EventTSRecord.Builder newBuilder(EventTSRecord.Builder other) {
    return new EventTSRecord.Builder(other);
  }
   ...
   * @return A new EventTSRecord RecordBuilder
   */
  public static EventTSRecord.Builder newBuilder(EventTSRecord other) {
    return new EventTSRecord.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EventTSRecord>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(EventTSRecord.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(EventTSRecord other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.eventArray)) {
        this.eventArray = data().deepCopy(fields()[0].schema(), other.eventArray);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public EventTSRecord.Builder setEventArray(java.util.List<Event> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public EventTSRecord.Builder clearEventArray() {
      eventArray = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public EventTSRecord.Builder setLabel(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public EventTSRecord.Builder clearLabel() {
      label = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public EventTSRecord.Builder setTStart(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public EventTSRecord.Builder clearTStart() {
    ...
    /**
      ...
      * @return This builder.
      */
    public EventTSRecord.Builder setTEnd(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public EventTSRecord.Builder clearTEnd() {
    ...
    public EventTSRecord build() {
      try {
        ...
        record.eventArray = fieldSetFlags()[0] ? this.eventArray : (java.util.List<Event>) defaultValue(fields()[0]);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<EventTSRecord>
    WRITER$ = (org.apache.avro.io.DatumWriter<EventTSRecord>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<EventTSRecord>
    READER$ = (org.apache.avro.io.DatumReader<EventTSRecord>)MODEL$.createDatumReader(SCHEMA$);

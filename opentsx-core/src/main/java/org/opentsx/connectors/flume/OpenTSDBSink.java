...
import org.opentsx.connectors.opentsdb.OpenTSDBEvent;
...
public class OpenTSDBSink extends AbstractSink implements Configurable {
    ...
    public Status process() throws EventDeliveryException {
        ...
        try {
            ...
            if (event != null) {
                ...
                // if the org.opentsx.tsbucket.metadata extractor is set, extract the topic and the key.
    ...
    public void configure(Context context) {
        ...
        // For example, kafka.org.opentsx.tsbucket.metadata.broker.list = localhost:9092 is a property that is processed here, but not

 ...
 *
 * mvn exec:java -Dexec.mainClass="org.opentsx.udf.hive.UDFTester"
 *
 * /usr/java/jdk1.7.0_67-cloudera/bin/java -cp target/cuda-org.opentsx.tsa-0.2.0-SNAPSHOT-jar-with-dependencies.jar org.opentsx.udf.hive.UDFTester
 *
 *
 * sudo -u hdfs hdfs dfs -rm /user/admin/udf/udf-h-org.opentsx.tsa.jar
 * sudo -u hdfs hdfs dfs -put target/cuda-org.opentsx.tsa-0.2.0-SNAPSHOT-jar-with-dependencies.jar /user/admin/udf/udf-h-org.opentsx.tsa.jar
 * sudo -u hdfs hdfs dfs -chmod 777 /user/admin/udf/udf-h-org.opentsx.tsa.jar
 * sudo -u hdfs hdfs dfs -chown admin:admin /user/admin/udf/udf-h-org.opentsx.tsa.jar
 *
 */

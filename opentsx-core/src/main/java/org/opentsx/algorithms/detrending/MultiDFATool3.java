...
import org.opentsx.algorithms.detrending.methods.DFAmulti;
 ...
 * @author kamir
 */
public class MultiDFATool3 {

    public static boolean logLogResults = false;
    public static boolean debug;

    public MultiDFATool3() {
        resetPuffer();
    };
    ...
    public static MultiDFATool3 tool = new MultiDFATool3();
            
    public static void calcMultiDFA(Vector<TimeSeriesObject> vmr , int phase, String v) {
//
//        System.out.println( vmr.size() + " Reihen in Phase: " + phase );
//        MultiChart.open(vmr, "Messwerte - [Phase " + phase + "] (all rows)", "t", "y(s)", false, "?");

        tool = new MultiDFATool3();
    ...
    public static void main(String[] main) {
        ...
        MultiDFATool3 tool = new MultiDFATool3();
...
//            MultiChart.open(fsF2, "Anzahl Segmente je s - [Phase " + phase + "]  [order:" + order + "] (all rows)", "s", "#Segmente", false, "?");
     ...
     * @return 
     */
    static public TimeSeriesObject getMWKurve() {

...
public class MacroRecorder3 {
    ...
    public static String label_of_TRACK = "EXP5_Cassandra";

    static String keyspace = "ks1";
    static String tablename = "tsb";
    ...
    public static void main(String[] args) throws Exception {
        ...
        //***********************************************************
        //
        // We load the initial dataset from Cassandra ...
        TSBucket tsb = TSBucketStore.getReader().loadBucket_Cassandra( keyspace, tablename );
        Vector<TimeSeriesObject> components = tsb.getBucketData();

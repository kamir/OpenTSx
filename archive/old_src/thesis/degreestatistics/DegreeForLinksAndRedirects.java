package org.opentsx.thesis.degreestatistics;
...
public class DegreeForLinksAndRedirects {
     ...
     public static void main(String[] args) throws IOException {
        ...
        DataFileTool.head( new File( pathoffset + fileNameJoinedRedirects ) , 10 );
        
        System.out.println(fileNameJoinedLinks);
        DataFileTool.head( new File( pathoffset + fileNameJoinedLinks ) , 10 );
        
        System.out.println(fileNameMasterJoin);
        DataFileTool.head( new File( pathoffset + fileNameMasterJoin ) , 10 );

...
# Generate PDF
gitbook pdf . OpenTSx-Complete-Documentation.pdf

# Or generate for specific sections
gitbook pdf manual OpenTSx-Manual.pdf
gitbook pdf onboarding OpenTSx-Onboarding-Paths.pdf
```

...
// fit with polysolve for higher grades than 2
    public double[] fitn(int u, int o, int n) throws Exception {
        
        throw new Exception( "!!! WARNING !!! A fit with n=" + n + " parameters not yet supported. \n=>" + this.getClass().getName() + " -> fitn(int u, int o, int n) ... "  );

...
import statphys.detrending.MFDFATester;
 ...
 * @author kamir
 */
public class FileControlerPanel2 extends javax.swing.JPanel {

    /**
     * Creates new form FileControlerPanel2
     */
    public FileControlerPanel2() {
        initComponents();
    }
    ...
    FileControlerPanel2(Vector<Messreihe> r, JFreeChart c, String l, JTextArea jtf) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(FileControlerPanel2.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//                dfa.initIntervalSlog();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
            MFDFATester.process(this.rows, "MFDFA of " + this.label);
        } catch (Exception ex) {
            Logger.getLogger(FileControlerPanel2.class.getName()).log(Level.SEVERE, null, ex);
        }

package org.apache.hadoopts.app.thesis.degreestatistics;
...
public class DegreeForLinksAndRedirects {
     ...
     public static void main(String[] args) throws IOException {
        ...
        org.apache.hadoopts.data.io.datafile.DataFileTool.head( new File( pathoffset + fileNameJoinedRedirects ) , 10 );
        
        System.out.println(fileNameJoinedLinks);
        org.apache.hadoopts.data.io.datafile.DataFileTool.head( new File( pathoffset + fileNameJoinedLinks ) , 10 );
        
        System.out.println(fileNameMasterJoin);
        org.apache.hadoopts.data.io.datafile.DataFileTool.head( new File( pathoffset + fileNameMasterJoin ) , 10 );
